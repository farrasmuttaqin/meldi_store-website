          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black">Sepatu Pria</h2> <?php 
                ...
                <div class="d-flex">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                      <a class="dropdown-item" href="<?php echo base_url(); ?>shop/maz">Name, A to Z</a>
                      <a class="dropdown-item" href="<?php echo base_url(); ?>shop/mza">Name, Z to A</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="<?php echo base_url(); ?>shop/mlowhigh">Price, low to high</a>
                      <a class="dropdown-item" href="<?php echo base_url(); ?>shop/mhighlow">Price, high to low</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <?php  if ($menFilter != ""){
                $a=0; foreach($menFilter as $pria){ $a++; }
            } ?>
            
            <div class="row mb-5" <?php if ($a!=0) echo "id='pagin'"; ?>>
            
            <?php if ($menFilter == ""){ ?>
            <?php $tampungmen=0; $tampungwoman=0; foreach($woman as $wanita){$tampungwoman++; } foreach($men as $pria){ ?>
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                    <a href="<?php echo base_url("shop/detail/".$pria->id_product); ?>"><img src="<?php echo base_url("assets/produkPria/".$pria->productImage); ?>" alt="Image placeholder" class="img-fluid"></a>
                  </figure>
            ...
            <?php $tampungmen++; } }else{ $g=0; $tampungmen=0; $tampungwoman=0; foreach($woman as $wanita){$tampungwoman++; } foreach($men as $pria){ $tampungmen++; } foreach($menFilter as $pria){ $g++; ?>
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            ...
            <div class="border p-4 rounded mb-4">
              <div class="mb-4">
                ...
                <form action="<?php echo base_url(); ?>shop/mprice" method="GET">

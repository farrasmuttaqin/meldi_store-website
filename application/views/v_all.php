          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black">Semua Sepatu</h2> <?php 
                ...
                <div class="d-flex">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                      <a class="dropdown-item" href="<?php echo base_url(); ?>shop/az">Name, A to Z</a>
                      <a class="dropdown-item" href="<?php echo base_url(); ?>shop/za">Name, Z to A</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="<?php echo base_url(); ?>shop/lowhigh">Price, low to high</a>
                      <a class="dropdown-item" href="<?php echo base_url(); ?>shop/highlow">Price, high to low</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <?php  $a=1; if ($allFilter != ""){
                $a=0; foreach($allFilter as $semua){ $a++; }
            } ?>
            
            <div class="row mb-5" <?php if ($a!=0) echo "id='pagin'"; ?>>
            
            <?php if ($allFilter == ""){ ?>
            <?php $tampungmen=0; $tampungwoman=0; foreach($woman as $wanita){$tampungwoman++; } foreach($men as $pria){$tampungmen++; } foreach($all as $semua){ ?>
            ...
            <?php } }else{ $g=0; $tampungmen=0; $tampungwoman=0; foreach($woman as $wanita){$tampungwoman++; } foreach($men as $pria){ $tampungmen++; } foreach($allFilter as $semua){ $g++; ?>
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            ...
            <div class="border p-4 rounded mb-4">
              <div class="mb-4">
                ...
                <form action="<?php echo base_url(); ?>shop/price" method="GET">

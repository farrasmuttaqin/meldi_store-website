...
jQuery(document).ready(function($) {
    ...
    $( "#slider-range" ).slider({
      ...
      slide: function( event, ui ) {
        $( "#amount" ).val( convertToRupiah(ui.values[0]) + " - " + convertToRupiah(ui.values[1]));
    ...
    $( "#amount" ).val( convertToRupiah($( "#slider-range" ).slider( "values", 0 )) +
      " - " + convertToRupiah($( "#slider-range" ).slider( "values", 1 )) );
